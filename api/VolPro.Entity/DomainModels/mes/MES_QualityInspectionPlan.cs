...
{
    [Entity(TableCnName = "质量检验",TableName = "MES_QualityInspectionPlan",DetailTable =  new Type[] { typeof(MES_QualityInspectionPlanDetail)},DetailTableCnName = "质检明细",DBServer = "ServiceDbContext")]

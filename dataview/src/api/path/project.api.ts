...
// * 修改项目基础信息
export const updateOrderNoProjectApi = async (data: any) => {
  try {
    const res = await http(RequestHttpEnum.POST)(`${ModuleTypeEnum.PROJECT}/updateOrderNo`, data)
    return res
  } catch {
    httpErrorHandle()
  }
...
// * 修改项目基础信息
export const copyProjectApi = async (data: any) => {
  try {

  ...
  <n-layout-header bordered class="go-header">
    <header class="go-header-box" :class="{ 'is-project': isProject }">
      <div class="header-item left">
        <n-space>
          <slot name="left"></slot>
          <span style="color: #9b9b9b;letter-spacing: 3px;font-size: 13px;">已获取商业授权,请放心使用...</span>
        </n-space>
      </div>
      <div v-show="false" class="header-item center">
      ...
      <div class="header-item right">
        <n-space>
          ...
          <go-theme-select></go-theme-select>
           <template v-show="false">  <slot name="ri-right"></slot></template>

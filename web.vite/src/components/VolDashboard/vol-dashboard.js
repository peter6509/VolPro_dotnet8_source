...
const base = {
  ...
  }), A = ["提交訂單", "訂單配貨", "廠家發貨", "物流運輸", "客户簽收", "訂單完成"], l = [
    "廠家已接到訂單,預計20分鐘將分配訂單...",
    "廠家正在揀貨...",
    "商品通知物流公司取件",
    "物流已取件,商品正在運行途中",
  ...
  let l = {
    ...
    消費: ~~(Math.random() * 1e3),
    餘額                                                                                                                                                                                                                                                 : ~~(Math.random() * 1e3),
    地址: "北京市海淀區中關村南大街33號10层1001室"
  };
  return e ? l.同比增長 = 65 : l.備註 = "這家伙很懶,没有留下任何可以看的說明信息...", l;
}, rankingData = () => [
  { name: "合格率", value: 95 },
  { name: "成品率", value: 80 },
  { name: "送检率", value: 70 },
...
const VolTitle = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["render", _sfc_render], ["__scopeId", "data-v-eac0b45f"]]), _hoisted_1$a = { class: "vol-data-table" }, _hoisted_2$9 = { class: "vol-da-table" }, _hoisted_3$9 = {
          ...
          default: withCtx(() => [
            createElementVNode("div", _hoisted_3$7, [
              (openBlock(!0), createElementBlock(Fragment, null, renderList(e.data, (a, r) => (openBlock(), createElementBlock("div", {
                ...
                a.date ? (openBlock(), createElementBlock("div", _hoisted_7$3, "時間：" + toDisplayString(a.date), 1)) : createCommentVNode("", !0),
  ...
  setup(e, { emit: A }) {
    const l = e, i = ref("基礎設置"), a = filter, r = [
      { value: "-1", name: "隐藏圖例" },
      { value: "left", name: "靠左" },
    ...
    return y.http.post("api/Sys_Dictionary/GetVueDictionary", ["dbServer"]).then((k) => {
      ...
      return openBlock(), createElementBlock(Fragment, null, [
        createVNode(M, {
          ...
          header: withCtx(() => [
            createTextVNode(toDisplayString(k.$ts("圖標")), 1)
          ]),
          footer: withCtx(() => [
            ...
            createElementVNode("div", _hoisted_8$1, [
              createVNode(D, {
                ...
                default: withCtx(() => [
                  _hoisted_9$1,
                  createTextVNode(toDisplayString(k.$ts("關閉")), 1)
                ]),
                _: 1
              }),
              createVNode(D, {
                ...
                default: withCtx(() => [
                  _hoisted_10$1,
                  createTextVNode(toDisplayString(k.$ts("確定")), 1)
                ]),
                _: 1
              })
            ])
                      ...
                      createVNode(s, {
                        ...
                        default: withCtx(() => [
                          createVNode(S, {
                            ...
                            placeholder: "日期固定參數名@date12如：select xx from table where 日期字段 BETWEEN @date1 and @date2"
                          }, null, 8, ["modelValue"])
                        ]),
                        _: 1
                      })
                ...
                e.currentItem.type != "pie" ? (openBlock(), createBlock(B, {
                  ...
                  default: withCtx(() => [
                    createVNode(s, {
                      "label-align": "left",
                      span: 1,
                      label: e.currentItem.type == "ranking" ? "進度條背景" : "標題顏色"
                    }, {
                      default: withCtx(() => [
  ...
  setup(e, { emit: A }) {
    ...
    return watch(
      ...
      return e.filterType == "纵向顯示" ? (openBlock(), createBlock(h, { key: 0 }, {
        dropdown: withCtx(() => [
          createVNode(v, null, {
            default: withCtx(() => [
      ...
      proxy.http.post(A, {}, !0).then((l) => {
        ...
        if (l.options)
          try {
            ...
            console.log("加載配置異常：" + l.options), console.log(a);
          }

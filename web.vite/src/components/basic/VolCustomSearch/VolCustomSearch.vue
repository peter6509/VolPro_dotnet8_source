    ...
    >
      <div class="custom-search">
        <div class="custom-content">
          ...
          <div class="custom-attr">
            <div class="custom-title"><i class="el-icon-paperclip"></i> {{ $ts('屬性配置') }}</div>
            <el-scrollbar style="height: 100%; padding: 10px">
              ...
              <div class="attr-item" v-show="!isDate() && !isNubmer()">
                ...
                >
                  ...
                  <el-radio label="select">{{ '單選' }}</el-radio>
                  <el-radio label="selectList">{{ '多選' }}</el-radio>
                </el-radio-group>
              ...
              <div class="attr-item" v-if="isDate()">
                ...
                <div>
                  <el-radio-group v-model="currentItem.type" @change="rangeChange">
                    <el-radio label="datetime" style="margin-right: 10px">{{
                      'datetime'
                    }}</el-radio>
                    <el-radio label="date" style="margin-right: 10px">{{ 'date' }}</el-radio>
                    <el-radio label="month">{{ '年月' }}</el-radio>
                  </el-radio-group>
                </div>
              </div>
              <div class="attr-item" v-if="isDate() || isNubmer()">
                <div class="attr-item-title">{{ isDate() ? '日期範圍查詢' : '數字範圍查詢' }}</div>
              ...
              <div class="attr-item">
                <div class="attr-item-title">標籤寬度</div>
      ...
      <template #footer>
        <div class="filter-bottom">
          ...
          <div>
            <el-button type="primary" plain size="small" @click="model = false">關閉</el-button>

    ...
    export default defineComponent({
        setup() {
            ...
            const columns = ref([{field:'Order_Id',title:'Order_Id',type:'guid',width:110,hidden:true,readonly:true,require:true,align:'left'},
                       ...
                       {field:'TotalQty',title:'總數量',type:'int',width:70,align:'left'},
                       ...
                       {field:'OrderStatus',title:'訂單狀態',type:'int',bind:{ key:'訂單狀態',data:[]},hidden:false,width:90,require:true,align:'left'},

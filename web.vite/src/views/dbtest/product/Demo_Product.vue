 ...
 *業務請在@/extension/dbtest/product/Demo_Product.jsx此處編寫
 -->
<template>
    <view-grid ref="grid"
               :columns="columns"
...
<script>
    ...
    export default defineComponent({
        setup() {
            ...
            const editFormOptions = ref([[{"title":"商品名稱","required":true,"field":"ProductName"},
            ...
            const searchFormOptions = ref([[{"title":"商品名稱","field":"ProductName","type":"like"},{"title":"商品編號","field":"ProductCode","type":"like"},{"dataKey":"audit","data":[],"title":"審核狀態","field":"AuditStatus","type":"select"},{"title":"創建時間","field":"CreateDate","type":"datetime"}]]);
            const columns = ref([{field:'ProductId',title:'ProductId',type:'guid',width:110,hidden:true,readonly:true,require:true,align:'left'},
                       {field:'ProductName',title:'商品名稱',type:'string',link:true,width:200,require:true,align:'left'},
                       {field:'ProductCode',title:'商品編號',type:'string',width:120,require:true,align:'left'},
                       {field:'Price',title:'價格',type:'decimal',width:60,require:true,align:'left'},
                       {field:'AuditStatus',title:'審核狀態',type:'int',bind:{ key:'audit',data:[]},width:80,align:'left'},
                       {field:'Remark',title:'備註',type:'string',width:80,align:'left'},
                       {field:'CreateID',title:'CreateID',type:'int',width:80,hidden:true,align:'left'},
                       {field:'Creator',title:'創建人',type:'string',width:80,readonly:true,align:'left'},
                       {field:'CreateDate',title:'創建時間',type:'datetime',width:140,readonly:true,align:'left'},
                       {field:'ModifyID',title:'ModifyID',type:'int',width:80,hidden:true,align:'left'},
                       {field:'Modifier',title:'修改人',type:'string',width:80,readonly:true,align:'left'},
                       {field:'ModifyDate',title:'修改時間',type:'datetime',width:140,readonly:true,align:'left'}]);
            ...
            const details = ref([  { 
                    ...
                    columns: [{field:'ProductColorId',title:'ProductColorId',type:'guid',width:110,hidden:true,readonly:true,require:true,align:'left'},
                       ...
                       {field:'Color',title:'顏色',type:'string',bind:{ key:'顏色',data:[]},width:100,edit:{type:'radio'},require:true,align:'left'},
                    ...
                    detail:{
                                    ...
                                    columns: [{field:'ProductSizeSubId',title:'ProductSizeSubId',type:'guid',width:110,hidden:true,readonly:true,require:true,align:'left'},
                                              {field:'ProductSizeId',title:'ProductSizeId',type:'guid',width:110,hidden:true,align:'left'},
                                              {field:'ChestCircumference',title:'ChestCircumference',type:'string',width:120,edit:{type:''},require:true,align:'left'},
                                              {field:'WaistCircumference',title:'WaistCircumference',type:'string',width:130,edit:{type:''},require:true,align:'left'},
                                              {field:'HipCircumference',title:'HipCircumference',type:'string',width:120,edit:{type:''},require:true,align:'left'},
                                              {field:'ShoulderWidth',title:'ShoulderWidth',type:'string',width:120,edit:{type:''},require:true,align:'left'},
                                              {field:'Remark',title:'Remark',type:'string',width:150,edit:{type:''},align:'left'},
                                              {field:'CreateID',title:'CreateID',type:'int',width:80,hidden:true,align:'left'},
                                              {field:'Creator',title:'Creator',type:'string',width:100,hidden:true,align:'left'},

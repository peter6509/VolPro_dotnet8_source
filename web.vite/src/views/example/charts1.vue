...
import { ref, reactive, onMounted, defineExpose, defineEmits, getCurrentInstance } from 'vue'
...
const tabs = reactive([
  ...
  { name: '採購訂單', icon: '', orderType: 2, count: 0, totalPrice: 0, qty: 0 },
  { name: '退貨訂單', icon: '', orderType: 3, count: 0, totalPrice: 0, qty: 0 },
  { name: '促銷訂單', icon: '', orderType: 4, count: 0, totalPrice: 0, qty: 0 },
  { name: '預约訂單', icon: '', orderType: 5, count: 0, totalPrice: 0, qty: 0 }
])

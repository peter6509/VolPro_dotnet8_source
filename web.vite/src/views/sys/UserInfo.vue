<template>
  <input ref="input" type="file" accept=".png, .jpg, .jpeg" style="display: none" @change="handleChange"
    :multiple="false" />
  <VolBox :width="500" :height="270" v-model="modifyOptions.model" title="修改密碼">
      ...
      <div class="left">
        <div>
          ...
          <div class="text">
            ...
            <p>
              <el-button type="error" @click="modifyPwd" size="small" plain long>修改密碼</el-button>
              <el-button style="padding: 3px 16px" @click="showUpload" plain type="primary" size="mini"
                ghost>修改頭像</el-button>
            </p>
          </div>
        </div>
      </div>
  ...
  methods: {
    ...
    savePwd() {
      ...
      if (
        ...
        return this.$message.error("兩次密碼不一致");
      }
      let url =

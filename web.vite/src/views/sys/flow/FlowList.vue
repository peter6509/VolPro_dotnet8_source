  ...
  <div class="home-content" data-v-7f6868a7="">
    <el-scrollbar style="height: 100%;">
      <!-- <div style="margin:10px 0 -5px 12px;font-size: 14px;font-weight: bold;">
        <i class="el-icon-warning-outline"></i> 發起流程
      </div> -->
      ...
      <div class="home-list">
        <div class="list-item" @click="itemClick(item, index)" v-for="(item, index) in list" :key="index">
          <div class="content">
            <div class="content-right">
              ...
              <div class="data" data-v-7f2e9c68="">
                <!-- {{ item.desc }} -->
               <el-button type="primary" link> 發起流程</el-button>
              </div>
          ...
          <div :class="[item.type == '審批' ? 'item-strengthen' : (item.type == '新增' ? 'item-new' : 'item-other')]">{{
            item.type }}</div>
        </div>
      </div>
    </el-scrollbar>

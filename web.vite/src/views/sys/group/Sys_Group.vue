 ...
 *業務請在@/extension/system/group/Sys_Group.js此處編寫
 -->
<template>
    <view-grid ref="grid"
               :columns="columns"
...
<script>
    ...
    export default defineComponent({
        setup() {
            ...
            const editFormOptions = ref([[{"title":"集團名稱","required":true,"field":"GroupName"}],
                              [{"title":"電话","field":"PhoneNo"}],
            ...
            const columns = ref([{field:'GroupId',title:'GroupId',type:'guid',width:110,hidden:true,readonly:true,require:true,align:'left'},
                       {field:'GroupName',title:'集團名稱',type:'string',link:true,width:150,require:true,align:'left',sort:true},
                       {field:'PhoneNo',title:'電话',type:'string',width:140,align:'left'},
